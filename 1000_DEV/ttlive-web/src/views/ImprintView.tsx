...
const ImprintView = () => {
    ...
    return <React.Fragment>
        ...
        <Typography>Schwärzler, David</Typography>
        <Typography>Am Gleise 42</Typography>
        <Typography>20539 Hamburg</Typography>

        <h3>{t("ImprintView.contact")}</h3>
        <Typography>0178 8219472</Typography>
        <Typography>schwaerzler.da@gmail.com</Typography>
        ...
        die außerhalb unseres Verantwortungsbereichs liegen, würde eine Haftungsverpflichtung ausschließlich in dem Fall nur bestehen, wenn wir von den Inhalten Kenntnis erlangen und es uns technisch möglich und zumutbar wäre, die Nutzung im Falle rechtswidriger Inhalte zu verhindern.
        </p>
        <p>
